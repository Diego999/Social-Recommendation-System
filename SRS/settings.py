...
DATABASES = {
    'default': {
        ...
        'NAME': 'srs_database',                      # Or path to database file if using sqlite3.
...
SITE_ID = u'525ffdba6f509c0be05a8239'
...
SECRET_KEY = '6991iv_uy5ayigg(=n8rbthff*_&w-c0g_@ujbvtvgv(1&&6)9'
